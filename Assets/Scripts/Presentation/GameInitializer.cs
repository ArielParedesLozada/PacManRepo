...
public class GameInitializer : MonoBehaviour
{
    ...
    [Inject] private IConsumeBonusItemUseCase _consumeBonusItemUseCase;
    ...
    IEnumerator InitializeAfterBoardIsReady()
    {
        ...
        if (controller != null)
        {
            controller.Initialize(_moveUseCase, entity, _pacManView, _consumePelletUseCase, _consumeBonusItemUseCase);
